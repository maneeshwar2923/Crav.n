              ...
              if (_savingPhone)
                const SizedBox(
                  ...
                  child: CircularProgressIndicator(
                      strokeWidth: 2, color: cravnPrimary),
                ),
            ],
          ),
          const SizedBox(height: 12),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              const Icon(Icons.location_on_outlined, color: Color(0xFF006D3B)),
              const SizedBox(width: 8),
              const Text(
                'Addresses',
                style: TextStyle(fontSize: 16, fontWeight: FontWeight.w700),
  ...
  Widget _buildOrdersSection() {
    if (_orders.isEmpty) {
      return Container(
        ...
        child: const Text(
            'You have no past orders yet. Rescue a meal to see it here.'),
      );
    }
        ...
        children: [
          ...
          ..._orders.take(5).map((order) {
            ...
            return ListTile(
              ...
              subtitle: Text(
                  'Status: ${order['status']} ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ Qty: ${order['quantity']}'),
  ...
  Widget _buildSupportSection() {
    return Container(
      ...
      child: Column(
        ...
        children: [
          ListTile(
            leading: const Icon(Icons.notifications_outlined, color: cravnPrimary),
