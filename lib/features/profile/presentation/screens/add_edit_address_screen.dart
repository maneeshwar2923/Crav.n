...
[
  ...
  Future<void> _saveAddress() async {
    ...
    try {
      final result = await SupabaseService.instance.upsertAddress(payload);

      if (mounted) {
        setState(() => _loading = false);
        if (result != null) {
          if (_isDefault && result['id'] != null) {
            await SupabaseService.instance.markDefaultAddress(result['id']);
          }
                ...
                child: Column(
                  children: [
                    ...
                    SwitchListTile(
                      ...
                      value: _isDefault,
                      activeColor: const Color(0xFF006D3B),
