/* Central place to store (and later secure) Supabase configuration.
    Replace the placeholder values with your own or load them from a
    runtime secret manager / env file (e.g. flutter_dotenv) before shipping. */
import 'package:flutter_dotenv/flutter_dotenv.dart';
import 'package:flutter/foundation.dart';

class SupabaseConfig {
  // Fallback constants (dev) – overridden by --dart-define or .env
